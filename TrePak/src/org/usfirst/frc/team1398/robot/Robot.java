...
public class Robot extends IterativeRobot {
	...
	private MecanumDrive speedRacer; 
	private Joystick sunnyD; 
	...
	public void robotInit() {
		...
		speedRacer = new MecanumDrive (frontLeft, rearLeft, frontRight, rearRight);
		
		sunnyD = new Joystick (kJoystickChannel);
